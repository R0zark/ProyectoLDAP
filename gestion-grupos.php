  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Administración de Grupos</h3>
        <div class="row mb">
          <!-- page start-->
          ...
          <div class="form-usuario-panel">
            <h4 class="mb"><i class="fa fa-angle-right"></i> Información de la Grupos</h4> <button
              class="btn btn-success-usuario btn-anyadir" value=""><i class="glyphicon glyphicon-plus"></i> Añadir
              Grupo</button>
            <div class="contenido">
              <div class="input">
                <p>Nombre</p>
              ...
              <div class="input">
                ...
                <select class="ou-disponibles">
                  <option value="">NADA</option>
                </select>
              </div>
              <div class="input">
                <p>Numero Identificador</p>
                <input class="input-id" type="input" value="" readonly required="required" pattern="[0-9]">
              </div>
              <div class="input">
                <p>Descripcción</p>
                <textarea class="form-control input-descripcion" readonly required="required"
                  placeholder="Escribe una descripción aquí"></textarea>
              </div>
            </div>
            <br>
    ...
    $(document).ready(function () {
      ...
      $("#modificar").click(function () {
        ...
        var parametros = {
                ...
                "ou"  : $(".ou-disponibles").val(),
                "idgrupo" : $("input-id").val(),
      ...
      $(".btn-aceptar").click(function () {
        ...
        $(".btn-cancelar").hide();
        $(".mb h4").text("Información del Grupo");
        $(".form-usuario-panel").removeAttr("style");
      });

      $(".btn-cancelar").click(function () {
        $(".btn-success-usuario").fadeIn();
        $(".form-usuario-panel input,textarea, select").attr("readonly", true);
        $(this).hide();
        $(".btn-aceptar-modificar").hide();
        $(".btn-danger-usuario").fadeIn();
        $("#modificar").fadeIn();
      ...
      $(".btn-aceptar-anyadir").click(function () {
        ...
        $(".content-usuario-panel").fadeIn();
        $(".form-usuario-panel").removeAttr("style");
        if (confirm("Desea añadir el Grupo: " + $(".input-nombre").val() + "?")) {
          var parametros = {
            "accion": "agregar",
            "objetivo": "grupo",
            "nombre": $(".input-nombre").val(),
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              $.ajax({
                ...
                success: function (response) {
                  $(".filas").html(response);
                  $.getScript("ver-info-grupo.js", function () {
                  })
                }
              })
            }
      ...
      $(".btn-anyadir").click(function () {
        $(this).hide();
        $(".btn-cancelar").fadeIn();
        $(".form-usuario-panel input,textarea, select").removeAttr("readonly");
        $(".btn-aceptar-anyadir").fadeIn();
        $(".btn-danger-usuario").hide();
        $("#modificar").hide();
        $(".form-usuario-panel input, textarea").val("");
        $(".mb h4").text("Añadir Grupo");
        $(".content-usuario-panel").hide();
        $(".form-usuario-panel").css("width", "100%");
      });
      ...
      $(".btn-aceptar-modificar").click(function(){
          ...
          $(".content-usuario-panel").fadeIn();
          $(".form-usuario-panel").removeAttr("style");
          if(confirm("¿Desea modificar el Grupo : " + $(".input-nombre").val() + "?")){
          var parametros = {
              "accion": "modificar",
              "objetivo": "grupo",
              "nombre": $(".input-nombre").val(),
      ...
      $(".btn-danger-usuario").click(function () {
        if (confirm("Desea eliminar el Grupo: " + $(".input-nombre").val() + "?")) {
          var parametros = {
            "accion": "eliminar",
            "objetivo": "grupo",
            "ou": $(".ou-disponibles").val(),
